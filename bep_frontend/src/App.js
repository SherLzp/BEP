...
import { PushResponseContent } from './_pages/request'
...
import {
  ...
  ReceivedResponsesContentContainer,
  PushRequestContentContainer,
}
  from './_containers'
      ...
      <BrowserRouter>
        <Layout>
          <Switch>
            ...
            <Route path="/requests/pushRequest" component={PushRequestContentContainer}></Route>
            {/* Response Part */}
            <Route path="/responses/yourResponses" component={YourResponsesContentContainer}></Route>
            <Route path="/responses/receivedResponses" component={ReceivedResponsesContentContainer}></Route>
